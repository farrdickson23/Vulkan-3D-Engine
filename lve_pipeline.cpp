...
namespace lve {
	...
	void LvePipeline::defaultPipelineConfigInfo(PipelineConfigInfo& configInfo) {
		...
		// how rasterizer handes the edges of geometries i.e. not have jaged edges
		...
		// additional attatchment to frame buffer
	...
	void LvePipeline::enableAlphaBlending(PipelineConfigInfo& configInfo) {
		...
		configInfo.colorBlendAttachment.srcAlphaBlendFactor = VK_BLEND_FACTOR_ONE; // not used now
		configInfo.colorBlendAttachment.dstAlphaBlendFactor = VK_BLEND_FACTOR_ZERO; // not used now
		configInfo.colorBlendAttachment.alphaBlendOp = VK_BLEND_OP_ADD; // not used now
	}
}